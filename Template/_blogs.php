...
#gallery {
  position: relative; /* Ensures that h1 is positioned relative to the section */
}

#gallery h1 {
  position: absolute; /* Absolute positioning for precise control */
  top: -120px; /* Adjust this value to move the heading upwards */
  ...
  text-align: center;
  font-size: 3em;
  text-shadow: -1px -1px 0px #FFA75F, 3px 3px 0px #FFD78A, 6px 6px 0px #FF835F;
}
</style>
...
<div class="section-fluid-main">
		...
		<div class="section-row">
			...
			<div class="section-col">
				...
				<div class="section">
					...
					<div class="section-in">
						...
						<img src="https://i.postimg.cc/0QnJRjtd/pets-3715733-1920.jpg" alt="">
					</div>
				</div>
			</div>
			...
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="https://i.postimg.cc/1Rj6BgbD/friends-3042751-1920.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
			...
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="https://i.postimg.cc/WbZ8xLRW/cat-2934720-1920.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
			...
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="https://i.postimg.cc/BngTGJmg/dog-1861839-1920.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
			...
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="https://i.postimg.cc/Y9XD218d/cat-1941089-1920.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
			...
			<div class="section-col">
				<div class="section">
					<div class="section-in">
						<img src="https://i.postimg.cc/3NFXJ7KY/dog-3239718-1920.jpg" alt="">
					</div>
				</div>
			</div>
			<div class="hover-text">
